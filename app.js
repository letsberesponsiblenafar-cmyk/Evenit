...
const pageTemplates={
  ...
  messages:`<div class="page-header"><p class="overline">Keep the plan moving</p><h2>Messages</h2></div><div class="message-list"><div class="message"><img src="https://i.pravatar.cc/100?img=25"><div><strong>maya.rose</strong><p>Should we bring extra blankets for the picnic?</p></div><small>2m</small></div><div class="message"><img src="https://i.pravatar.cc/100?img=47"><div><strong>ari.makes</strong><p>That coffee walk sounds perfect.</p></div><small>1h</small></div><div class="empty-message">Your conversations will live here.<br><span>Join a plan to meet someone new.</span></div></div><div style="margin-top:28px;border-top:1px solid #E8E8ED;padding-top:20px"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px"><div><p style="margin:0;font:600 11px -apple-system,sans-serif;letter-spacing:0.06em;text-transform:uppercase;color:#6E6E73">Private circles</p><h3 style="margin:4px 0 0;font:700 18px -apple-system,sans-serif;letter-spacing:-0.02em">Groups</h3><p style="color:#6E6E73;font-size:12px;margin:2px 0 0">Telegram-like, private, only members see messages.</p></div><button class="publish-button" id="open-group-create" style="width:auto;border-radius:999px;padding:8px 16px;font-size:13px">＋ Create</button></div><div id="groups-list" class="groups-list" style="margin-top:0"></div></div>`,
