...
function showAgendaDetail(planId,options={}){
  ...
  const verificationAction=needsVerification?`<button class="agenda-primary" data-agenda-verify="${escapeHtml(post.id)}">${needsProfileDetails?'Add details and continue':'Authorize organizer and continue'}</button>`:'';
